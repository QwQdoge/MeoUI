    ...
    readonly property var categories: [
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoMotionSurface", "components/MeoMotionSurface.qml", "Elevated surface primitive with reusable entrance and press motion.", "elevated, filled, outlined, interactive, entrance directions", "Resting, pressed, revealed", "type, interactive, bouncy, color, radius, elevation, reveal()", "MeoMotionSurface { animateOnCompleted: true }"),
