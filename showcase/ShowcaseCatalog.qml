    ...
    readonly property var categories: [
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoMenu", "components/MeoMenu.qml", "M3 popup menu with elevated reusable surfaces, spring-driven row feedback, compact context mode, labels, dividers, shortcuts, selection, supporting text, and operational submenus.", "standard, context, vibrant, checked, separator, label, shortcut, submenu", "Open, hover spring, press spring, keyboard, focus, selected, disabled, RTL", "model, surfaceStyle, vibrant, itemSpacing, menuPadding, menuHorizontalInset, currentIndex, open(), openAt(), openSubmenu(), submenuRequested", "MeoMenu { model: [{ label: \"Copy\", icon: \"content_copy\", shortcut: \"Ctrl+C\" }] }"),
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoInteractionMotion", "components/MeoInteractionMotion.qml", "Visual-free spring feedback for clickable surfaces. Hosts keep pointer ownership and consume scale/translation outputs.", "calm, pixel, playful, hover, press, active", "Resting, hovered, pressed, retargeted, reduced motion", "pressed, hovered, active, motionProfile, scaleValue, offsetX, offsetY", "MeoInteractionMotion { pressed: button.down; hovered: button.hovered }"),
                component("MeoRevealMotion", "components/MeoRevealMotion.qml", "Visual-free spring reveal driver for transient surfaces, popup contents, cards, and sheets.", "calm, pixel, playful, custom hidden scale/offset", "Hidden, revealing, visible, hiding, interrupted", "revealed, hiddenScale, hiddenOffsetX, hiddenOffsetY, scaleValue, opacityValue, offsetX, offsetY", "MeoRevealMotion { revealed: popupOpen }"),
