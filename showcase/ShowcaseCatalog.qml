    ...
    readonly property var categories: [
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoPageHost", "components/MeoPageHost.qml", "Animated host for asynchronously replacing page components or QML sources while preserving a directional transition.", "component source, URL source, forward, backward", "Initial page, loading, transitioning, replacement", "source, sourceComponent, sourceProperties, pageKey, direction, asynchronous, showComponent()", "MeoPageHost { sourceComponent: homePage }"),
