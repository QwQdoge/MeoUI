    ...
    readonly property var categories: [
        {
            ...
            "components": [
                ...
                component("MeoAiMark", "components/MeoAiMark.qml", "Canonical Meo AI identity mark with a fixed lavender field and white monogram.", "default mark, custom container, custom mark color", "Default brand mark, recolored host treatment", "containerColor, markColor, cornerRadius", "MeoAiMark { width: 48; height: 48 }"),
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoMonthCalendar", "components/MeoMonthCalendar.qml", "Keyboard-accessible month calendar primitive for a single selected date.", "current month, selected day, locale first day", "Selected day, today, adjacent month days, non-interactive", "selectedDate, displayDate, focusedDate, interactive, firstDayOfWeek", "MeoMonthCalendar { selectedDate: new Date() }"),
                component("MeoSpinBox", "components/MeoSpinBox.qml", "Numeric input with MeoUI typography, dynamic focus color, and touch-sized increment actions.", "editable, min/max, step", "Default, focused-ready, disabled-ready", "from, to, value, stepSize, editable", "MeoSpinBox { from: 0; to: 100; value: 42; stepSize: 2 }"),
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoScrollBar", "components/MeoScrollBar.qml", "Semantic dynamic-color scrollbar with hover, pressed, and auto-hide feedback.", "vertical, horizontal, hover, pressed, active", "Idle, active, hovered, pressed", "orientation, policy, position, size", "MeoScrollBar { orientation: Qt.Vertical; policy: ScrollBar.AlwaysOn; size: 0.35 }"),
                component("MeoSteppedSlider", "components/MeoSteppedSlider.qml", "Accessible stepped slider with explicit decrease and increase controls.", "continuous, discrete, value label, suffix", "Low, middle, high, discrete steps", "title, supportingText, from, to, value, stepSize, discrete, showValueLabel", "MeoSteppedSlider { title: \"Volume\"; value: 60; stepSize: 10 }"),
                ...
                component("MeoQuickSettingsTile", "components/MeoQuickSettingsTile.qml", "Resizable Pixel-style quick-settings pill with dynamic tonal states and a drag-ready edit state.", "Pixel pill, compact, wide, active, inactive, edit", "Pill, dynamic tonal state, resizing", "title, supportingText, iconName, active, wide, visualStyle, editMode", "MeoQuickSettingsTile { title: \"Wi-Fi\"; iconName: \"wifi\"; active: true; wide: true; visualStyle: \"pixel\" }"),
                ...
                component("MeoRatingBar", "components/MeoRatingBar.qml", "Star rating input with partial ratings and an optional read-only presentation.", "small, medium, large, read-only", "Empty, partial, full, read-only", "maxRating, rating, readOnly, size, activeColor, inactiveColor", "MeoRatingBar { rating: 3.5; size: \"m\" }"),
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoAppGridItem", "components/MeoAppGridItem.qml", "Launcher-grid item with a stable touch target, icon slot, label, and selection state.", "regular, compact, selected, custom icon content", "Default, selected, compact", "title, iconName, iconContent, selected, compact", "MeoAppGridItem { title: \"Settings\"; iconName: \"settings\" }"),
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoExpansionPanel", "components/MeoExpansionPanel.qml", "Expandable content panel with a tappable header, icon, subtitle, and custom content slot.", "collapsed, expanded, icon, custom content", "Collapsed, expanded, hovered, pressed", "title, subtitle, icon, expanded, contentItem", "MeoExpansionPanel { title: \"Advanced\"; expanded: true }"),
                ...
                component("MeoSegmentedList", "patterns/MeoSegmentedList.qml", "Reusable grouped list that assigns segmented rounding to a supplied delegate.", "header, segmented, custom delegate", "Single item, first, middle, last", "title, model, delegate, isSegmented, itemSpacing", "MeoSegmentedList { title: \"Recent\"; model: rows; delegate: listItem }"),
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoMediaCard", "components/MeoMediaCard.qml", "Content card with media placement, header identity, supporting copy, and action model.", "small, medium, large, top, bottom, left, right", "Filled, outlined, selected, interactive", "cardSize, mediaPosition, headerTitle, title, supportingText, actions", "MeoMediaCard { title: \"Release notes\"; mediaPosition: \"top\" }"),
                ...
                component("MeoSettingsAccountCard", "widgets/MeoSettingsAccountCard.qml", "Settings identity card with a 92 dp tonal surface and 48 dp avatar.", "settings account, avatar, navigation", "Default, hover, pressed, keyboard focus", "title, subtitle, avatarSource, initials, showChevron", "MeoSettingsAccountCard { title: \"Shekong\"; subtitle: \"Local session\" }"),
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoShapeMorph", "components/MeoShapeMorph.qml", "Shape primitive that interpolates between compatible expressive path topologies.", "source shape, target shape, fill, stroke, rotation", "Start, midpoint, complete", "fromShape, toShape, morphProgress, rawSpringProgress, color, rotationAngle", "MeoShapeMorph { fromShape: \"SoftBurst\"; toShape: \"Cookie9Sided\"; morphProgress: 0.5 }"),
