    ...
    readonly property var categories: [
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoMediaController", "widgets/MeoMediaController.qml", "Media playback control surface with compact, control-center, desktop-dashboard, lock-screen, and full-screen presentations.", "compact, control center, dashboard, unavailable seek, lock screen, full screen", "Six configurations, playing, paused, desktop dashboard, multi-player switching, disabled seek, backend-gated optional actions", "presentation, title, artist, album, duration, position, volume, canSeek, canShuffle, canRepeat, repeatMode, sourceCount, showFavoriteAction, showOutputAction, showBackdropArtwork", "MeoMediaController { title: \"Track\"; presentation: \"dashboard\" }"),
