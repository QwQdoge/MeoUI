    ...
    readonly property var categories: [
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoRevealMotion", "components/MeoRevealMotion.qml", "Interruptible open/closed reveal state shared by popouts, panes, cards, and shell surfaces. Supports two-dimensional spatial travel plus scale while preserving the vertical scalar compatibility API.", "active, inactive, reduced motion, custom scale, X/Y travel", "Open, closed, diagonal reveal, retargeted in flight, reduced motion", "active, motionEnabled, spatialMotionAllowed, resolvedOpenState, motionProfile, speed, openScale, closedScale, openOffset, closedOffset, openOffsetX, closedOffsetX, openOffsetY, closedOffsetY, resolvedScale, resolvedOffset, resolvedOffsetX, resolvedOffsetY, snapToActiveState()", "MeoRevealMotion { active: panel.opened; closedOffsetX: 6; closedOffsetY: -MeoMotion.popupOffset(\"pixel\") * MeoTheme.globalScale }"),
