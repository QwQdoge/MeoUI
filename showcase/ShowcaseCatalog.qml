    ...
    readonly property var categories: [
        {
            ...
            "components": [
                ...
                component("MeoMotion", "MeoMotion.qml", "AndroidX Material3 standard and expressive spring-token contract with analytic, unit-mass sampling plus shared interaction/reveal amplitudes.", "standard and expressive; default, fast, slow; spatial/effects; hover/press; popup reveal", "Source-token spring values, calm/pixel/playful amplitude profiles, sampled settling", "defaultSpatial, fastSpatial, slowSpatial, defaultEffects, fastEffects, slowEffects, hoverScale(), hoverLift(), pressScale(), popupEntranceScale(), popupExitScale(), popupOffset(), pageOffset(), stateAt(), isAtRest()", "Use this semantic motion contract for new M3 motion; component amplitudes come from these helpers and spring stiffness is sampled analytically rather than passed to Qt SpringAnimation."),
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoInteractionMotion", "components/MeoInteractionMotion.qml", "Presentation-agnostic hover, press, and active-state spring driver for toolbars, launchers, cards, and compact controls.", "rest, hover, press, active, reduced motion", "Resting, lifted hover, compressed press, active surface, interrupted retarget", "enabled, hovered, pressed, active, motionProfile, speed, scale, offsetY, hoverScale, pressedScale", "Bind scale and a Translate y to this primitive instead of hard-coding per-control spring constants."),
                component("MeoRevealMotion", "components/MeoRevealMotion.qml", "Host-agnostic spring reveal state for popovers, shell-owned surfaces, side panels, and lazily created content.", "hidden, shown, interrupted, reduced motion", "Hidden, revealing, shown, hiding, retargeted in flight", "shown, enabled, motionProfile, speed, scale, opacity, offsetX, offsetY, hiddenScale, hiddenOffsetX, hiddenOffsetY", "Use when the host owns visibility and MeoMotionPopup cannot own the lifecycle."),
                ...
                component("MeoMotionPopup", "components/MeoMotionPopup.qml", "Animated Popup base with analytic spring reveal for menus/dialogs, pre-open measurement, retained exit content, nested transient protection, and viewport-aware anchor placement.", "dialog spring reveal, menu anchor reveal, bottom sheet, side sheet, full screen, anchored transient", "Closed, spring opening, open, spring closing, child transient, reduced motion", "presentation, surfaceRadius, surfaceColor, scrimOpacity, motionProfile, springReveal, entranceScale, exitScale, openFrom(), contentActive, placement, registerTransientSurface()", "MeoMotionPopup { presentation: MeoMotionPopup.Dialog; motionProfile: \"pixel\" }")
            ]
        },
        {
            "id": "feedback",
