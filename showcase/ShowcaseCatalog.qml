    ...
    readonly property var categories: [
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoRevealMotion", "components/MeoRevealMotion.qml", "Interruptible open/closed reveal state shared by popouts, panes, cards, and shell surfaces.", "active, inactive, reduced motion, custom scale and offset", "Open, closed, retargeted in flight, reduced motion", "active, motionProfile, speed, openScale, closedScale, openOffset, closedOffset, resolvedScale, resolvedOffset, snapToActiveState()", "MeoRevealMotion { active: panel.opened; closedOffset: -8 * MeoTheme.globalScale }"),
