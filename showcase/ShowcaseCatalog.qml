    ...
    readonly property var categories: [
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoInteractionMotion", "components/MeoInteractionMotion.qml", "Interruptible hover, press, and active motion shared by controls, cards, toolbar triggers, and shell surfaces.", "rest, hover, pressed, active, reduced motion", "Rest, hovered, pressed, active, retargeted in flight", "hovered, pressed, active, motionProfile, speed, resolvedScale, resolvedOffsetX, resolvedOffsetY, snapToCurrentState()", "MeoInteractionMotion { hovered: button.hovered; pressed: button.down; active: selected }"),
