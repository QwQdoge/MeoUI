    ...
    readonly property var categories: [
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoStatusStrip", "components/MeoStatusStrip.qml", "Backend-agnostic compact system-status row driven by semantic status maps.", "connected, active, tonal active color, attention, text-hidden, unavailable", "Active state can match any semantic tonal container while keeping an accessible status summary", "statusModel, active, activeContentColor, showText, iconSize, textScale", "MeoStatusStrip { statusModel: [{ id: \"wifi\", iconName: \"wifi\", active: true }] }"),
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoInteractionMotion", "components/MeoInteractionMotion.qml", "Reusable analytic-spring transform state for hover, press, and active surfaces.", "resting, hover, pressed, active, reduced motion", "Resting, lifted hover, compressed press, open/active emphasis", "hovered, pressed, active, enabled, motionProfile, scale, offsetY, snapToState()", "MeoInteractionMotion { hovered: hoverHandler.hovered; pressed: tapHandler.pressed }"),
