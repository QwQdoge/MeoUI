    ...
    readonly property var categories: [
        ...
        },
        {
            ...
            "components": [
                ...
                component("MeoContextMenu", "components/MeoContextMenu.qml", "Pointer-positioned Pixel/MD3 context menu with separated rounded action cards, shared elevation, and the standard menu keyboard/submenu contract.", "segmented cards, context target, selection, disabled, submenu, vibrant", "Right-click position, pointer, keyboard, focus, selected, disabled, RTL", "model, openAtPoint(anchor, localX, localY), currentIndex, submenuRequested", "MeoContextMenu { model: [{ label: \"Add widget\", icon: \"widgets\" }] }"),
